...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut().insert(GrpcMethod::new("canto.csr.v1.Query", "Params"));
        ...
        pub async fn cs_rs(
            ...
            tonic::Response<super::QueryCsRsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("canto.csr.v1.Query", "CSRs"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn csr_by_nft(
            ...
            tonic::Response<super::QueryCsrByNftResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("canto.csr.v1.Query", "CSRByNFT"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn csr_by_contract(
            ...
            tonic::Response<super::QueryCsrByContractResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("canto.csr.v1.Query", "CSRByContract"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn turnstile(
            ...
            tonic::Response<super::QueryTurnstileResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("canto.csr.v1.Query", "Turnstile"));
            self.inner.unary(req, path, codec).await
        }
    }
}
