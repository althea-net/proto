...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("canto.vesting.v1.Query", "Balances"));
...
pub struct MsgCreateClawbackVestingAccount {
    ...
    pub lockup_periods: ::prost::alloc::vec::Vec<
    ...
    pub vesting_periods: ::prost::alloc::vec::Vec<
        cosmos_sdk_proto::cosmos::vesting::v1beta1::Period,
    >,
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("canto.vesting.v1.Msg", "Clawback"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub struct ClawbackVestingAccount {
    ...
    pub base_vesting_account: ::core::option::Option<
        cosmos_sdk_proto::cosmos::vesting::v1beta1::BaseVestingAccount,
    >,
