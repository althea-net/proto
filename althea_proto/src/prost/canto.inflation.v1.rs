...
pub struct QueryEpochMintProvisionResponse {
    ...
    #[prost(message, optional, tag = "1")]
    pub epoch_mint_provision: ::core::option::Option<
...
pub struct QueryCirculatingSupplyResponse {
    ...
    #[prost(message, optional, tag = "1")]
    pub circulating_supply: ::core::option::Option<
        cosmos_sdk_proto::cosmos::base::v1beta1::DecCoin,
    >,
}
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn period(
            ...
            tonic::Response<super::QueryPeriodResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("canto.inflation.v1.Query", "Period"));
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("canto.inflation.v1.Query", "EpochMintProvision"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn skipped_epochs(
            ...
            tonic::Response<super::QuerySkippedEpochsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("canto.inflation.v1.Query", "SkippedEpochs"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("canto.inflation.v1.Query", "CirculatingSupply"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("canto.inflation.v1.Query", "InflationRate"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("canto.inflation.v1.Query", "Params"));
            self.inner.unary(req, path, codec).await
        }
    }
}
