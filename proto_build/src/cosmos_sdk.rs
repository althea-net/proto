...
fn compile_sdk_protos_and_services(
    ...
    let proto_paths = [
        ...
        &format!("{}proto/cosmos/circuit", root.display()),
        &format!("{}proto/cosmos/consensus", root.display()),
        ...
        &format!("{}proto/cosmos/group", root.display()),
        &format!("{}proto/cosmos/mint", root.display()),
        &format!("{}proto/cosmos/nft", root.display()),
        &format!("{}proto/cosmos/orm", root.display()),
