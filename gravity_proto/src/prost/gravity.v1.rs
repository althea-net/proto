...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("gravity.v1.Msg", "SendToEth"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn confirm_logic_call(
            ...
            tonic::Response<super::MsgConfirmLogicCallResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("gravity.v1.Msg", "SubmitBadSignatureEvidence"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gravity.v1.Query", "LastPendingValsetRequestByAddr"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gravity.v1.Query", "LastPendingBatchRequestByAddr"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gravity.v1.Query", "LastPendingLogicCallByAddr"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn logic_confirms(
            ...
            tonic::Response<super::QueryLogicConfirmsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("gravity.v1.Query", "GetLastObservedEthBlock"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("gravity.v1.Query", "GetLastObservedEthNonce"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_attestations(
            ...
            tonic::Response<super::QueryAttestationsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gravity.v1.Query", "GetDelegateKeyByValidator"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gravity.v1.Query", "GetDelegateKeyByOrchestrator"),
                );
            self.inner.unary(req, path, codec).await
        }
