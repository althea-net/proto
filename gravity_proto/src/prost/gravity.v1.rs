...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SendToCosmosClaimComponents {
    #[prost(uint64, tag = "1")]
    pub event_nonce: u64,
    #[prost(uint64, tag = "2")]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct BatchSendToEthClaimComponents {
    #[prost(uint64, tag = "1")]
    pub event_nonce: u64,
    #[prost(uint64, tag = "2")]
    pub eth_block_height: u64,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Erc20DeployedClaimComponents {
    #[prost(uint64, tag = "1")]
    pub event_nonce: u64,
    #[prost(uint64, tag = "2")]
    pub eth_block_height: u64,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct LogicCallExecutedClaimComponents {
    #[prost(uint64, tag = "1")]
    pub event_nonce: u64,
    #[prost(uint64, tag = "2")]
    pub eth_block_height: u64,
    /// Raw bytes; formatted with %s during reconstruction
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ValsetUpdatedClaimComponents {
    #[prost(uint64, tag = "1")]
    pub event_nonce: u64,
    #[prost(uint64, tag = "2")]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ClaimHashComponents {
    /// The actual components used in ClaimHash()
    #[prost(oneof = "claim_hash_components::Components", tags = "1, 2, 3, 4, 5")]
    pub components: ::core::option::Option<claim_hash_components::Components>,
}
/// Nested message and enum types in `ClaimHashComponents`.
pub mod claim_hash_components {
    /// The actual components used in ClaimHash()
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Components {
        #[prost(message, tag = "1")]
        SendToCosmos(super::SendToCosmosClaimComponents),
        #[prost(message, tag = "2")]
        BatchSendToEth(super::BatchSendToEthClaimComponents),
        #[prost(message, tag = "3")]
        Erc20Deployed(super::Erc20DeployedClaimComponents),
        #[prost(message, tag = "4")]
        LogicCallExecuted(super::LogicCallExecutedClaimComponents),
        #[prost(message, tag = "5")]
        ValsetUpdated(super::ValsetUpdatedClaimComponents),
    }
}
...
pub struct Attestation {
    ...
    #[prost(enumeration = "ClaimType", tag = "5")]
    pub claim_type: i32,
    #[prost(message, optional, tag = "6")]
    pub claim_components: ::core::option::Option<ClaimHashComponents>,
}
...
impl ClaimType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "CLAIM_TYPE_UNSPECIFIED",
            Self::SendToCosmos => "CLAIM_TYPE_SEND_TO_COSMOS",
            Self::BatchSendToEth => "CLAIM_TYPE_BATCH_SEND_TO_ETH",
            Self::Erc20Deployed => "CLAIM_TYPE_ERC20_DEPLOYED",
            Self::LogicCallExecuted => "CLAIM_TYPE_LOGIC_CALL_EXECUTED",
